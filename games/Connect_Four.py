...
class ConnectFour(Game):
    ...
    """check_max gives the maximum number of consecutive positions 
    ...
    def run(self):
        ...
        #draw a green ball at given position
        def greenball(x,y):
            screen.blit(player1img,(x,y))
        
        #draw a blue ball at given position
        def blueball(x,y):
            screen.blit(player2img,(x,y))
        
        #animation for dropping green ball into a column
        ...
        #animation for dropping blue ball into a column
